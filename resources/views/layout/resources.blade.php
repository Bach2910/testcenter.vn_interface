            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex align-items-center navbar-nav-right">
                    <li class="nav-item me-3">
                        <a class="nav-link container" aria-current="page" href="/blog">
                            <img src="https://www.testcenter.vn/blog/wp-content/uploads/2021/04/logo-e1617684193993.png" alt="Trang chủ"
                                 style="height: 30px; width:120px; margin-right: 8px;">
                        </a>
                    </li>
                </ul>
