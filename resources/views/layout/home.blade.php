...
<head>
    ...
    <link rel="stylesheet" href="{{asset('scss/interface2.css')}}">
            ...
            <nav class="container navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="form-inline">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link header-item" style="color: #2B4AA0" href="{{route('SignIn')}}" target="_blank">Đăng ký</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link header-item" style="color: #2C4A9F; font-weight: 500" href="{{route('Login')}}" target="_blank">Đăng nhập</a>
                            </li>
                        </ul>
                    </div>
                </div>
