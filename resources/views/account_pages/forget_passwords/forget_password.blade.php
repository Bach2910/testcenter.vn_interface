...
@endsection
@section('form')
    <div class="note-pass w-100 text-left">Enter the email used to register your account, the system will send
    ...
    <div class="login-container">
        ...
        <div class="register-link">
            Did you remember the password? <a href="{{route('login')}}">Login</a>
        </div>
    </div>
@endsection
