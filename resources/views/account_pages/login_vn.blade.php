...
@section('form')
    <div class="card-body p-0">
        ...
        <div class=" mt-4 d-flex justify-content-between mb-3">
            ...
            <div class="forgot"> <a href="{{route('forget_password_vn')}}">Quên mật khẩu</a></div>
        </div>
        <div class="login-container">
            <button class="topCv-login-button">Đăng Nhập</button>
            <div class="or-separator">Or</div>
            <div class="topCv-logo">
                <img src="{{asset('image/card/topcv-logo-4.png')}}" alt="TopCV Logo"/>
                <span>Login with TopCV</span>
            </div>
            <div class="register-link">
                Chưa có tài khoản ? <a href="{{route('register_vn')}}">Đăng ký</a>
            </div>
        </div>
    </div>
@endsection
