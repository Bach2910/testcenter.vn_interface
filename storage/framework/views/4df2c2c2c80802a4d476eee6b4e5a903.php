...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('scss/interface2.css')); ?>">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="form-inline">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link header-item  active" href="/">Trang chủ</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="form-inline">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link header-item" style="color: #2B4AA0" href="<?php echo e(route('SignIn')); ?>" target="_blank">Đăng ký</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link header-item" style="color: #2C4A9F; font-weight: 500" href="<?php echo e(route('Login')); ?>" target="_blank">Đăng nhập</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container p-5">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 pr-5 mb-4">
                        <img alt="Testcenter" class="w-100 noselect" src="https://app.testcenter.vn/images/logo/logo_white_3x.png" alt>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <h2 style="margin-bottom: 15px;" class="text-white font-weight-bold font-size-16">VỀ TESTCENTER</h2>
                        <p>
...
<?php /**PATH C:\laragon\www\interface\resources\views/layout/home.blade.php ENDPATH**/ ?>