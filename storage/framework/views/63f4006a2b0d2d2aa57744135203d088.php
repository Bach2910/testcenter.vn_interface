                ...
                <div class="d-flex justify-content-center">
                    <div class="row text-center d-flex flex-column">
                        ...
                        <div class="form-inline justify-content-center button-group mt-3">
                            <div>
                                <a href="<?php echo e(route('SignIn')); ?>" target="_blank">
                    ...
                    <div style="color: #2B4AA0">
                        <a href="" style="color: #2B4AA0" target="_blank">
                            <div class="d-flex justify-content-center align-items-center">
                                <div><a href="<?php echo e(route('blog')); ?>">Tìm hiểu thêm</a></div>
            ...
            <section class="container py-3">
                ...
                <div class="row justify-content-center mt-3 font-weight-normal" style="font-size: 15px; line-height: 20px; font-weight: 500">
                    ...
                    <div class="ml-2" style="color: #2B4AA0">
                        <a href="<?php echo e(route('Login')); ?>" style="color: #2B4AA0" target="_blank">Đăng nhập</a>
                    </div>
                </div>
            </section>
        </div>
                                        ...
                                        <div class="card card-item">
                                            ...
                                            <div class="card-body">
                                                <div class="title-post">
                                                    <h3 class="card-title">
                                                        <a target="_blank" href="<?php echo e(route('blogLean')); ?>">IQ và EQ cái nào quan trọng hơn? Chọn yếu tố gì trong tuyển dụng</a>
                                                    </h3>
                                                </div>
                                                ...
                                                <div class="more text-center mt-3">
                                                    <div class="button-more">
                                                        <a target="_blank" style="color: #fff" href="<?php echo e(route('blogLean')); ?>" class="btn btn-primary border-0 font-weight-normal">
                                                            Đọc thêm
                                                        </a>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\interface\resources\views/index.blade.php ENDPATH**/ ?>