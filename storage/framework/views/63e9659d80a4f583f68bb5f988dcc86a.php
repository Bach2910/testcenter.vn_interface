    ...
    <div class="container">
        ...
        <div class="first-title">
            ...
            <em>Quản trị doanh nghiệp chưa bao giờ là một nhiệm vụ dễ dàng đối với các nhà quản lý. Nhưng với sự “dẫn
                ...
                thế nào để ứng dụng lý thuyết này hiệu quả khi quản trị doanh nghiệp? Hãy cùng <a href="<?php echo e(route('index')); ?>"
...
<?php echo $__env->make('layout.resources', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\interface\resources\views/pages/content2.blade.php ENDPATH**/ ?>