...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('scss/account.css')); ?>">
</head>
<body>
        ...
        <div class="right-div col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 box-action">
            <div class="card">
                <div class="country mb-5 mb-md-5 w-100">
                    <?php echo $__env->yieldContent('country'); ?>
                </div>
                <div class="logo text-center mb-2 mb-md-4 w-100"><img src="<?php echo e(asset('image/logo/register.png')); ?>" alt="icon">
                </div>
...
<script src="<?php echo e(asset('js/hidden-password.js')); ?>">
</script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
</body>
</html>
<?php /**PATH C:\laragon\www\interface\resources\views/layout/account.blade.php ENDPATH**/ ?>