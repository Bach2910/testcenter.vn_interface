        ...
        <div class="mb-4 product-section-intro">
            <div class="row">
                <div class="col-md-5 product-section-intro-left p-0 pt-3">
                    ...
                    <div class="mt-5">
                        <a class="btn btn-primary btn-register " href="<?php echo e(route('SignIn')); ?>">Đăng ký miễn phí</a>
                        <a class="btn btn-link font-weight-500 primary-color" href="<?php echo e(route('blog')); ?>">Tìm hiểu thêm</a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-12 product-section-price-box product-section-price-box-primary">
                    ...
                    <a href="<?php echo e(route('SignIn')); ?>" class="btn btn-register btn-light">Đăng ký miễn phí</a>
                </div>
                <?php for($i=0;$i<4;$i++): ?>
                <div class="col-md-2 col-12 product-section-price-box">
                    ...
                    <a href="<?php echo e(route('SignIn')); ?>" class="btn btn-register btn-secondary">Trải nghiệm ngay</a>
                </div>
                <?php endfor; ?>
            </div>
        </div>
...
<?php echo $__env->make('layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\interface\resources\views/product.blade.php ENDPATH**/ ?>