...
<?php $__env->startSection('form'); ?>
    <div class="card-body">
        ...
        <div class=" mt-4 d-flex justify-content-between mb-3">
            ...
            <div class="forgot"> <a href="<?php echo e(route('forgot')); ?>">Quên mật khẩu</a></div>
        </div>
        ...
        <div class="note mt-2">
            <p>Don't have account <a href="<?php echo e(route('SignIn')); ?>">Đăng ký</a></p>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layout.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\interface\resources\views/loginVN.blade.php ENDPATH**/ ?>