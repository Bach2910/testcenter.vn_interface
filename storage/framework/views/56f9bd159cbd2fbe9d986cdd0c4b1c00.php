...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('scss/resources.css')); ?>">
    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-center navbar-nav-right">
                <li class="nav-item me-3">
                    <a class="nav-link" href="<?php echo e(route('index')); ?>"><span class="highlight">Trang chủ</span></a>
                </li>
                <li class="nav-item me-3">
...
<?php /**PATH C:\laragon\www\interface\resources\views/layout/resources.blade.php ENDPATH**/ ?>