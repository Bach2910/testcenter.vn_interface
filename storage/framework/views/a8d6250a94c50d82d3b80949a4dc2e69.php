<?php $__env->startSection('main'); ?>
    <div class="container">
        ...
        <div class="first-title">
            ...
            <h5>Quản trị doanh nghiệp chưa bao giờ là một nhiệm vụ dễ dàng đối với các nhà quản lý. Nhưng với sự “dẫn
                ...
                thế nào để ứng dụng lý thuyết này hiệu quả khi quản trị doanh nghiệp? Hãy cùng <a href="#"
                                                                                                  class="high-light">Testcenter</a>
                tìm hiểu về “bí quyết” đặc biệt này ngay sau đây. </h5>
...
<?php echo $__env->make('layout.resources', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\interface\resources\views/content/content2.blade.php ENDPATH**/ ?>