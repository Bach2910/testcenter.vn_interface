...
<?php $__env->startSection('form'); ?>
    <div class="card-body">
        ...
        <div class=" mt-4 d-flex justify-content-between mb-3">
            ...
            <div class="forgot"> <a href="<?php echo e(route('forgot')); ?>">Forgot Password</a></div>
        </div>
        ...
        <div class="note mt-2">
            <p>Don't have account <a href="<?php echo e(route('SignIn')); ?>">Sign up</a></p>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<script src="<?php echo e(asset('js/translate-vn-en/login.js')); ?>">
</script>


<?php echo $__env->make('layout.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\interface\resources\views/logins/login.blade.php ENDPATH**/ ?>